    ...
    return (
        <div id='navbar' className='navbar'>
            ...
            <ul ref={menuRef} className='nav-menu'>
                ...
                <li><AnchorLink className='anchor-link' offset={50} href='#services'><p onClick={()=>setMenu("services")}>Projects</p></AnchorLink>{menu==="services"?<img src={underline}/>:<></>}</li>
                <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("work")}>Highlights</p></AnchorLink>{menu==="work"?<img src={underline}/>:<></>}</li>
